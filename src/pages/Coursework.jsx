  ...
  return (
    <div className="max-w-5xl mx-auto animate-in fade-in duration-500">
      <div className="mb-10 flex items-center gap-4">
        <div className="p-3 bg-blue-900 rounded-xl text-white shadow-lg">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2 flex justify-between">
            <span>Major Subjects</span>
            <span className="text-sm font-semibold bg-blue-100 text-blue-800 px-3 py-1 rounded-full">BSRT Core</span>
          </h2>
              ...
              <div key={subject.code} className="bg-white p-4 rounded-xl border border-blue-100 shadow-sm flex items-start gap-4">
                ...
                <div className="w-full">
                  <div className="flex justify-between items-start mb-1">
                    <span className="font-bold text-blue-950">{subject.code}</span>
                    <span className="text-xs font-bold text-blue-600 bg-blue-50 px-2 py-1 rounded">
                      {subject.units} Units
                    </span>
                  </div>
                  <p className="text-sm font-semibold text-blue-800 leading-tight mb-2">{subject.title}</p>
                  <p className="text-xs text-blue-500 font-medium uppercase tracking-wider">{subject.year} • {subject.sem} Sem</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-bold text-blue-900 border-b-2 border-amber-200 pb-2 flex justify-between">
            <span>Minor Subjects</span>
            <span className="text-sm font-semibold bg-amber-100 text-amber-800 px-3 py-1 rounded-full">General Ed</span>
          </h2>
