    ...
    <div className="max-w-5xl mx-auto animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row gap-12">
        <div className="w-full md:w-1/3 space-y-6">
          <div className="aspect-[3/4] xray-screen rounded-3xl relative overflow-hidden flex items-center justify-center group shadow-md">
        ...
        <div className="w-full md:w-2/3 space-y-8">
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><User /></div>
              <div>
            ...
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><Calendar /></div>
              <div>
            ...
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><MapPin /></div>
              <div>
            ...
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><Heart /></div>
              <div>
            ...
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><Mail /></div>
              <div className="overflow-hidden">
                <p className="text-xs font-bold text-blue-400 uppercase tracking-wider">Email</p>
                <p className="font-semibold text-blue-950 truncate">marie@gmail.com</p>
              </div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-blue-100 flex items-center gap-4 shadow-sm">
              <div className="bg-blue-50 p-3 rounded-lg text-blue-600 shrink-0"><Phone /></div>
              <div>
          ...
          <div className="xray-box p-8 rounded-2xl">
            ...
            <div className="flex flex-wrap gap-2">
              {['Anatomy & Physiology', 'Radiation Protection', 'Patient Positioning', 'Medical Terminology', 'Vital Signs Monitoring', 'Image Processing', 'Healthcare Ethics', 'Financial Management (Org)'].map((skill) => (
                <span key={skill} className="px-4 py-2 bg-blue-900 text-blue-50 text-sm font-semibold rounded-lg text-center">
                  {skill}
                </span>
              ))}
            </div>
