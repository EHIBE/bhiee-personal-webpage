...
export default function Experience() {
  return (
    <div className="max-w-5xl mx-auto animate-in slide-in-from-right-8 duration-500">
      <div className="mb-12 text-center md:text-left md:pl-12">
      ...
      <div className="relative pl-6 sm:pl-8 md:pl-12">
        <div className="absolute left-[11px] sm:left-[15px] md:left-[15px] top-12 bottom-20 w-1 bg-blue-200 rounded-full z-0"></div>

        <div className="relative mb-16">
          <div className="absolute -left-[29px] sm:-left-[37px] md:-left-[41px] top-12 w-6 h-6 sm:w-7 sm:h-7 bg-blue-600 rounded-full border-4 border-[#fdfbf7] z-10 shadow-sm"></div>
          
          <div className="xray-box rounded-3xl relative overflow-hidden shadow-md ml-4 md:ml-4">
            ...
            <div className="p-6 md:p-8 pt-0 relative z-10">
              ...
              <div className="absolute top-24 right-0 p-8 opacity-5 text-blue-900 pointer-events-none hidden sm:block">
                <Building2 className="h-32 w-32" />
              </div>

              <div className="mb-6 relative z-10">
                <h2 className="text-2xl font-bold text-blue-950">Organization Treasurer</h2>
                <h3 className="text-blue-700 font-semibold mt-1 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 text-sm sm:text-base">
                  <span className="flex items-center gap-1"><Users className="h-4 w-4 shrink-0" /> RTSO ☢️</span>
                  <span className="hidden sm:inline">-</span>
                  <span>(Radiologic Technology Students' Organization)</span>
                </h3>
              </div>
              
              <ul className="space-y-3 text-blue-900/80 list-disc list-inside relative z-10 text-sm sm:text-base">
        ...
        <div className="relative">
          <div className="absolute -left-[29px] sm:-left-[37px] md:-left-[41px] top-12 w-6 h-6 sm:w-7 sm:h-7 bg-amber-500 rounded-full border-4 border-[#fdfbf7] z-10 shadow-sm"></div>

          <div className="bg-[#f4ebd0] border border-[#e6d5a7] p-6 sm:p-8 md:p-10 rounded-3xl shadow-sm relative overflow-hidden ml-4 md:ml-4">
            <div className="flex flex-col-reverse md:flex-row gap-10 items-center">
              <div className="w-full md:w-1/2 space-y-4 relative z-10">
                <div className="flex items-center gap-2 mb-2">
                  <HeartPulse className="h-5 w-5 text-amber-600 shrink-0" />
                ...
                <p className="text-blue-900/80 leading-relaxed py-2 text-sm sm:text-base">
              ...
              <div className="w-full md:w-1/2 relative h-56 sm:h-64 md:h-72 flex items-center justify-center">
                <div className="absolute inset-0 bg-amber-100/50 rounded-full blur-3xl -z-10"></div>
                
                <img 
                  src={agape1} 
                  alt="Agape Immersion 1" 
                  className="absolute w-36 h-48 sm:w-44 sm:h-56 md:w-48 md:h-64 object-cover rounded-xl shadow-xl -rotate-6 transform hover:rotate-0 hover:z-30 transition-transform duration-300 border-4 border-white z-10 -ml-8 sm:-ml-12"
                />
                <img 
                  src={agape2} 
                  alt="Agape Immersion 2" 
                  className="absolute w-36 h-48 sm:w-44 sm:h-56 md:w-48 md:h-64 object-cover rounded-xl shadow-xl rotate-6 transform hover:rotate-0 hover:z-30 transition-transform duration-300 border-4 border-white z-20 ml-12 sm:ml-16 md:ml-24 mt-8"
                />
              </div>
            </div>
          </div>
